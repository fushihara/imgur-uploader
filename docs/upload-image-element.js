...
export class UploadImageElement extends HTMLElement {
  ...
  `;
        this.elements = {
            self: this,
            画像: shadowRoot.querySelector("img"),
            progress: shadowRoot.querySelector("#progress"),
            link: shadowRoot.querySelector("#link"),
            percent: shadowRoot.querySelector("#percent"),
            resolution: shadowRoot.querySelector("#resolution"),
            extension: shadowRoot.querySelector("#extension"),
        };
    ...
    async 画像のファイルをセット(画像のblob, mime, アップロードに使うapiToken) {
    ...
    アップロードした画像のURLかnullを取得() {
        return this.画像のURL;
    }
}
customElements.define("upload-image", UploadImageElement);
//# sourceMappingURL=upload-image-element.js.map