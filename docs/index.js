...
const ドロップdiv = document.querySelector("#drop");
const テキストエリア = document.querySelector("#textarea");
const コピーボタン = document.querySelector("#copy");
const クリアボタン = document.querySelector("#clear");
const 画像リサイズ指定一覧 = [
    { radio: document.querySelector(`input[name="resize"][value="unlimited"]`), size: null },
    { radio: document.querySelector(`input[name="resize"][value="1920"]`), size: 1920 },
    { radio: document.querySelector(`input[name="resize"][value="1600"]`), size: 1600 },
    { radio: document.querySelector(`input[name="resize"][value="1280"]`), size: 1280 },
    { radio: document.querySelector(`input[name="resize"][value="1024"]`), size: 1024 },
    { radio: document.querySelector(`input[name="resize"][value="854"]`), size: 854 },
];
const pngの変換を強制 = document.querySelector("#pngtojpg");
const URLの自動コピー = document.querySelector("#autocopy");
const 画像一覧div = document.querySelector("#image-list");
...
async function 画像をリストに追加する(変換元のファイル, オリジナルのmime) {
...
async function 画像のフォーマットを変換(ファイル, mime) {
